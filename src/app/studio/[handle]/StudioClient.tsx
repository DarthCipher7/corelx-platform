...
export default function StudioClient({ handle }: { handle: string }) {
                ...
                <div className="p-4 bg-white/5 border-b border-white/10 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-white/45 block leading-tight mt-0.5">Perks: {tier.perks}</span>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-xl font-bold font-mono" style={{ color: tier.color }}>{auraScore}</span>
                    <span className="text-xs text-white/45 block mt-0.5">Total Aura</span>
                  </div>
                </div>
